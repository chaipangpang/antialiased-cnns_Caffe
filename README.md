...
### How to use  
Reference in [vgg16_antialiase_train.prototxt](https://github.com/chaipangpang/antialiased-cnns_Caffe/blob/master/model_example/VGG16/vgg16_antialiase_train.prototxt),[resnet18_antialiase_train.prototxt](https://github.com/chaipangpang/antialiased-cnns_Caffe/blob/master/model_example/ResNet18/resnet18_antialiase_train.prototxt) and [Anti-aliasing common downsampling layers in caffe](https://github.com/chaipangpang/antialiased-cnns_Caffe/blob/master/README.md#anti-aliasing-common-downsampling-layers-in-caffe).  
